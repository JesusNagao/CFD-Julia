...
function run_numeric(u::Array{Float64}, v::Array{Float64}, w::Array{Float64}, p::Array{Float64}, un::Array{Float64}, vn::Array{Float64}, wn::Array{Float64}, pn::Array{Float64}, nx::Int64, ny::Int64, nz::Int64, rho::Int64, dx::Float64, dy::Float64, dz::Float64, dt::Float64, F::Int64, X::Array{Float64}, Y::Array{Float64}, Z::Array{Float64})
    ...
    for i in range(2, stop=nx-1)
        for j in range(2, stop=ny-1)
            for k in range(2, stop=nz-1)
                p[i,j,k] = calc_p(u, v, w, dx, dy, dz, rho, i, j, k)
                u[i,j,k] = calc_u(u, v, w, i, j, k, rho, dx, dy, dz, dt, F)
                v[i,j,k] = calc_v(u, v, w, i, j, k, rho, dx, dy, dz, dt)
                w[i,j,k] = calc_w(u, v, w, i, j, k, rho, dx, dy, dz, dt)
            end
        end
    end
...
function calc_u(u::Array{Float64}, v::Array{Float64}, w::Array{Float64}, i::Int64, j::Int64, k::Int64, rho::Int64, dx::Float64, dy::Float64, dz::Float64, dt::Float64, F::Int64)
...
function calc_v(u::Array{Float64}, v::Array{Float64}, w::Array{Float64}, i::Int64, j::Int64, k::Int64, rho::Int64, dx::Float64, dy::Float64, dz::Float64, dt::Float64)
...
function calc_w(u::Array{Float64}, v::Array{Float64}, w::Array{Float64}, i::Int64, j::Int64, k::Int64, rho::Int64, dx::Float64, dy::Float64, dz::Float64, dt::Float64)
